const AgregarNota = () => {
    return (
        <>
            <div className="modalEditar agregarNota w-full h-screen bg-[#1118277e] fixed top-0 left-0 flex items-center justify-center p-4">
                <div className="md:w-[350px] w-full bg-[var(--color-principal-dashboard)]">
                    ...
                    <div className="flex flex-col gap-4 w-full h-full p-4">
                        <div className="flex gap-2 w-full">
                            ...
                            <input type="text" placeholder="" className="w-[150px] text-[1rem] pl-1 bg-[var(--color-principal-dashboard)] text-[var(--color-texto-dashboard)]" />
                        </div>
                        <div className="flex gap-2 w-full">
                            <p className="text-white">Nota: </p>
                            <textarea type="textarea"  className="w-[200px] h-[150px] text-[1rem] pl-1 bg-[var(--color-principal-dashboard)] text-[var(--color-texto-dashboard)] resize-none" />
                        </div>
