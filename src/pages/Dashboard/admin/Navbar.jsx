const Navbar = () => {
    return (
        <>
            <div className="w-[200px] h-screen bg-[var(--color-principal-light)] absolute lg:sticky top-0 left-0 translate-x-[-100%] lg:translate-x-0 navbar transition-all z-50">
