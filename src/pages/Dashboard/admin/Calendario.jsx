    ...
    return (
        <>
            <div classNameName="text-gray-700">
                ...
                <div classNameName="flex flex-grow w-screen h-screen overflow-auto">

                    <div classNameName="flex flex-col flex-grow">
                        <div classNameName="flex items-center mt-4">
                            <div classNameName="flex ml-6">
                                <button>
                                    <svg classNameName="w-6 h-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <div className="grid flex-grow w-full h-auto grid-cols-7 grid-rows-5 gap-px pt-px mt-1 bg-gray-200">
                            ...
                            <div className="relative flex flex-col bg-white group">
                                ...
                                <button className="absolute bottom-0 right-0 flex items-center justify-center hidden w-6 h-6 mb-2 mr-2 text-white bg-gray-400 rounded group-hover:flex hover:bg-gray-500">
                                    <svg  viewBox="0 0 20 20" fill="currentColor" className="w-6 h-6 plus"><path fill-rule="evenodd" d="M10 5a1 1 0 011 1v3h3a1 1 0 110 2h-3v3a1 1 0 11-2 0v-3H6a1 1 0 110-2h3V6a1 1 0 011-1z" clip-rule="evenodd"></path></svg>
                                </button>
                            </div>
