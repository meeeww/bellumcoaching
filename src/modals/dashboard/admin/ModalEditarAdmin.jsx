const ModalEditarAdmin = () => {
    return (
        <>
            <div className="modalEditarAdmin w-full h-screen bg-[#1118277e] fixed top-0 left-0 flex items-center justify-center p-4 hidden">
                <div className="md:w-[350px] w-full bg-[var(--color-principal-dashboard)]">
                    <div className="w-full h-[40px] bg-[var(--color-fondo-dashboard)] flex items-center justify-between px-4">
                        ...
                        <button className="h-full" onClick={() => { document.querySelector(".modalEditarAdmin").classList.add("hidden") }}>X</button>
                    </div>
